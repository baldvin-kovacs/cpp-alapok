...
int main() {
  ...
  // függetlenül attól, hogy milyen hosszú adatra mutatnak. Később majd látunk
  // megoldást arra, amikor nagyon 
  ...
  for (std::size_t i = 0; i < alakzatok.size(); ++i) {
    // Itt továbbra is baj van. A ../../images/pointer-vektor.png ábra szerint
    // az alakzatok[i] ugyan jó helyre mutat, de abszolut semmi nem tárolja, hogy
    // melyik pointer mutat esetleg egy Kor-re, vagy egy Teglalap-ra. A vektor
    // típusa csak azt mondja meg, hogy Alakzat-ra mutat, de hogy esetleg egy
    // leszármazottra, és hogy melyikre, azt nem. Ezért itt továbbra is a
    // bázis osztály terulet() metódusa hívódik, ami mindig nullát ad vissza.
